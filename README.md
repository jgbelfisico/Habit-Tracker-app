...
El proyecto se encuentra en la fase 4. Ya permite:
...
- ver una métrica simple basada en días completados
...
- `js/app.js`: conexión entre formulario, estado en memoria, eventos de clic y renderizado de la lista.
